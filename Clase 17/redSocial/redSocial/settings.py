...
SECRET_KEY = 'j=49jf(b8n4k*fb$jx#k7kk(y&n6tx8=x5o9wex!z&p2cp$x#g'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'social_django.context_processors.login_redirect' # Implemenar el login redirect :D
            ],
        },
    },
]
...
## Variables para controler el ingreso y salida (Rutas)
